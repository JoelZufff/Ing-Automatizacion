...
int main()
{
	cout << "Programa para realizar regla de Simpson 3/8 Simple y multiple";
	...
	// Llenado de datos para simpsom 3/8 multiple o simple
	...
	// Aplicacion del metodo de simpsom 3/8
	...
	double integral = (3 * delta / 8) * (fx.evaluate(a) + (3 * aux) + fx.evaluate(b));
