...
#fuses      INTRC, NOWDT, NOPROTECT, NOLVP, NOMCLR                // Fusibles (Configuraciones del microcontrolador)
//#device     PASS_STRINGS = IN_RAM
#use        delay(internal = 16MHz)                               // Configuracion de delay
//#use        rs232(rcv = pin_c7, xmit = pin_c6, baud = 9600, bits = 8, parity = n) 
#use        I2C (MASTER, FAST, stream = OLED_stream)
...
{  
   WireStation_init();
   char TEXTO[16] = "SIUUUUUU\0";

   OLED_ClearDisplay();
   OLED_DrawText(0, 0, TEXTO, 2);
   OLED_Display();

   // Funcion de pantalla de inicio
   while(true)
   {
      // Crear menu que se repite en un ciclo, donde se modifica su  
...
// Tamaño 1 caben 21 caracteres por fila
// Tamaño 2 caben 10 caracteres por fila
// Tamaño 3 caben 7 caracteres por fila
// Tamaño 4 caben 5 caracteres por fila
